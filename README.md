...
- Download and listen to audio tracks
...
2. Set up your environment:
   Create a .env file with your MongoDB connection details and server port
...
- YouTube integration for searching and downloading audio
